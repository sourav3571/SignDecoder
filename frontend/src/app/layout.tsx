...
export const metadata: Metadata = {
  title: "SignSpeak | Understanding Sign Language, Made Simple",
  description: "SignSpeak converts English text into sign language emoji sequences using advanced NLP — making communication accessible for everyone.",
};
